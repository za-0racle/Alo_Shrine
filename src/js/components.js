  ...
  return `
    ...
    <header class="site-header">
      <div class="container nav-shell">
        <a class="brand" href="/" aria-label="Khaleed Adedokun home">
          <span class="brand-mark"><img src="/images/brand/oracle-tek-mark.png" alt="" width="38" height="38"></span>
          <span><strong>Khaleed Adedokun</strong><small>Oracle du Kakanfo</small></span>
        </a>
  ...
  const socials = socialLinks
    ...
    .map((item) => {
      ...
      return item.url
        ...
        : `<span class="footer-social is-unavailable" role="img" aria-label="${item.label} link coming soon" data-label="${item.label}">${content}</span>`;
    })
    .join("");

  return `<footer class="site-footer"><div class="container footer-grid"><div><a class="brand footer-brand" href="/"><span class="brand-mark"><img src="/images/brand/oracle-tek-mark.png" alt="" width="38" height="38"></span><span><strong>${profile.name}</strong><small>${profile.identity}</small></span></a><p>Digital solutions, data insight and practical technology education.</p></div><div><h2>Explore</h2><div class="footer-links"><a href="/about.html">About</a><a href="/projects.html">Projects</a><a href="/writing.html">Writing</a></div></div><div><h2>Business</h2><p>Oracle TEK Global Solutions</p><a class="text-link" href="/oracle-tek.html">Explore services &rarr;</a></div><div><h2>Connect</h2><div class="footer-socials">${socials}</div><a class="text-link" href="/writing.html">Read my writing &rarr;</a></div></div><div class="container footer-bottom"><span>&copy; 2026 Khaleed Adedokun. All rights reserved.</span><span>Build. Teach. Solve.</span></div></footer>`;
}
...
export const placeholderVisual = (label, index = 0) =>
  `<div class="project-visual visual-${index % 4}" role="img" aria-label="Placeholder for ${label} project image"><span>${String(index + 1).padStart(2, "0")}</span><strong>${label}</strong><i aria-hidden="true"></i></div>`;
