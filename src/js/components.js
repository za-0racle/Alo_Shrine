...
export function renderFooter() {
  ...
  return `<footer class="site-footer"><div class="container footer-grid"><div><a class="brand footer-brand" href="/"><span class="brand-mark"><img src="/images/brand/oracle-tek-mark.png" alt="" width="38" height="38"></span><span><strong>${profile.name}</strong><small>${profile.identity}</small></span></a><p>Tech Educator &bull; Data Analyst &bull; Digital Solutions Creator</p></div><div><h2>Explore</h2><div class="footer-links"><a href="/about.html">About</a><a href="/projects.html">Projects</a><a href="/writing.html">Writing</a></div></div><div><h2>Business</h2><p>Oracle TEK Global Solutions</p><a class="text-link" href="/oracle-tek.html">Explore Oracle TEK &rarr;</a></div><div><h2>Connect</h2><div class="footer-socials">${socials}</div><a class="text-link" href="/writing.html">Read my writing &rarr;</a></div></div><div class="container footer-bottom"><span>&copy; 2026 ${profile.name}. All rights reserved.</span><span>${profile.message}</span></div></footer>`;
}
